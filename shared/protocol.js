...
export const PROTOCOL_ERROR_CODES = Object.freeze({
  ...
  WORKSPACE_RESIDUAL_PROCESS: "WORKSPACE_RESIDUAL_PROCESS",
  WORKSPACE_STAGING_NOT_QUARANTINED: "WORKSPACE_STAGING_NOT_QUARANTINED",
  WORKSPACE_PROVENANCE_MISMATCH: "WORKSPACE_PROVENANCE_MISMATCH",
  LEASE_CONFLICT: "LEASE_CONFLICT",
  SESSION_RETIREMENT_PENDING: "SESSION_RETIREMENT_PENDING",
  SESSION_RETIREMENT_FAILED: "SESSION_RETIREMENT_FAILED",
...
export const READINESS_ERROR_TAXONOMY = Object.freeze({
  ...
  workspaceMappingLease: Object.freeze([
    ...
    PROTOCOL_ERROR_CODES.WORKSPACE_RESIDUAL_PROCESS,
    PROTOCOL_ERROR_CODES.WORKSPACE_STAGING_NOT_QUARANTINED,
...
export const READINESS_REMEDIATIONS = Object.freeze({
  ...
  [PROTOCOL_ERROR_CODES.WORKSPACE_RESIDUAL_PROCESS]: remediationTuple(
    PROTOCOL_ERROR_CODES.WORKSPACE_RESIDUAL_PROCESS,
    true,
    "retry_later"
  ),
  [PROTOCOL_ERROR_CODES.WORKSPACE_STAGING_NOT_QUARANTINED]: remediationTuple(
    PROTOCOL_ERROR_CODES.WORKSPACE_STAGING_NOT_QUARANTINED,
    false,
    "contact_admin"
  ),
  [PROTOCOL_ERROR_CODES.WORKSPACE_PROVENANCE_MISMATCH]: remediationTuple(
    PROTOCOL_ERROR_CODES.WORKSPACE_PROVENANCE_MISMATCH,
    false,
    "contact_admin"
  ),
  ...
  [PROTOCOL_ERROR_CODES.SESSION_RETIREMENT_PENDING]: remediationTuple(
    PROTOCOL_ERROR_CODES.SESSION_RETIREMENT_PENDING,
    true,
    "retry_later"
  ),
  [PROTOCOL_ERROR_CODES.SESSION_RETIREMENT_FAILED]: remediationTuple(
    PROTOCOL_ERROR_CODES.SESSION_RETIREMENT_FAILED,
    false,
    "contact_admin"
  ),
